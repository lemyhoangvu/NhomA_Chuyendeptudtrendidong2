...
public class DulichAdapter extends ArrayAdapter<DuLich> {
	Activity context = null;
	int itemlayout;
	ArrayList<DuLich> arrNews = null;

	public DulichAdapter(Activity context, int motSanPham, ArrayList<DuLich> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.list_row_dulich, null);
		}
