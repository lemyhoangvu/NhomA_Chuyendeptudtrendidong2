...
public class Chitiet_dulich extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chitiet_dulich);
		...
		if(b != null) {
			DuLich dl = (DuLich) b.getSerializable("ct_dl");
		...
		buttonlienhe.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 // khởi tạo dialog
				dialog = new Dialog(Chitiet_dulich.this);
